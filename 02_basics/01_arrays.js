...
// myArr.push(6)  // .push() -> push function will add that value in an array.
// myArr.push(7)
// myArr.pop()    // .pop() -> pop function will remove the last value from that array.

// myArr.unshift(9)  // .unshift() -> unshift function add the value at '0' index in that array and due to this in backend all the previous value present in that array shifted forward, this maker the "system slow". So, This is "not good approch".
// myArr.shift()     // .shift()  -> shift function remove the value that present at '0' index.
...
// const newArr = myArr.join()  // .join() -> join function convert the array object into string.
// console.log(myArr);
...
// const myFirstArr_A = myOriginalArr.slice(1, 3)  // here .slice(n1, n2)  -> Slice function will return value from n1 index to (n2-1) index and it will not affect the original value.
// console.log(myFirstArr_A);  //Expcted o/p -> [1, 2]

// console.log("B ", myOriginalArr);   //Expcted o/p -> B [10, 1, 2, 3, 4, 5]
// const mySecondArr_B = myOriginalArr.splice(1, 3)   //Here .splice(n1, n2) -> Splice function will return value from (n1 to n2) index and it will also remove those value present in original array from (n1 to n2) index. 
// console.log(myFirstArr_A);  //Expcted o/p -> [1, 2]
